-nav"><button class="pf-btn pf-btn-next" onclick="pfNext()">Continuar →</button></div>`;
}
...
function startRenameColumn(colId){
  const col=KANBAN_COLUMNS.find(c=>c.id===colId);if(!